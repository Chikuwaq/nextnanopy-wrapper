...
def getDataFile_probabilities_with_name(name, software):
    """
...
def get_states_to_be_plotted(datafiles_probability_dict, software, states_range_dict=None, states_list_dict=None):
    """
                ...
                if software == 'nextnano++':
                    ...
                    for stateNo in states_list_dict[model]:
                        if stateNo == 'highestHole':
                            ...
                            df = getDataFile_in_folder(['occupation', model], outfolder, software)
                            try:
