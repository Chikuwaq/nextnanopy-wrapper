...
class CommonShortcuts:
    ...
    def detect_software(self, folder_path, filename):
        ...
        extension = self.separateFileExtension(filename)[1]
        if extension == '':
    ...
    def prepareInputFile(self,
        ...
        filename_no_extension, extension = self.separateFileExtension(originalFilename)
        if extension == '':
    ...
    def getSweepOutputFolderName(self, filename, *args):
        """
    ...
    def getSweepOutputFolderPath(self, filename, *args):
        """
    ...
    def get_output_subfolder_path(self, sweep_output_folder_path, input_file_name):
        ...
        """
        subfolder_name = self.separateFileExtension(input_file_name)[0]
        return os.path.join(sweep_output_folder_path, subfolder_name)


    def getSweepOutputSubfolderName(self, filename, sweepCoordinates):
        """
    ...
    def getDataFile(self, keywords, name, exclude_keywords=None):
        """
        ...
        return self.getDataFile_in_folder(keywords, outputSubfolder, exclude_keywords=exclude_keywords)


    def getDataFile_in_folder(self, keywords, folder_path, exclude_keywords=None):
        """
    ...
    def getDataFiles(self, keywords, name, exclude_keywords=None):
        """
        ...
        return self.getDataFiles_in_folder(keywords, outputSubFolder, exclude_keywords=exclude_keywords)


    def getDataFiles_in_folder(self, keywords, folder_path, exclude_keywords=None):
        """
                ...
                if model not in states_list_dict:
                    ...
                    for stateNo in states_list_dict[model]:
                        if stateNo == 'highestHole':
                            ...
                            df = self.getDataFile_in_folder(['occupation', model], outfolder)
                            try:
    ...
    def getValueAtPosition(self, quantity_arr, position_arr, wantedPosition):
        """
    ...
    def getPlotTitle(self, originalTitle):
        """
        If the title is too long for display, omit the intermediate letters
        """
        title = self.separateFileExtension(originalTitle)[0]   # remove extension if present
    ...
    def export_figs(self, 
            figFilename, 
            figFormat, 
            outputSubfolderName='nextnanopy', 
            output_folder_path='', 
            fig=None
            ):
        """
