...
class CommonShortcuts:
    ...
    def getSweepOutputFolderPath(self, filename, software, *args):
        """
    ...
    def getDataFile(self, keywords, name, software, exclude_keywords=None):
        """
    ...
    def getDataFiles(self, keywords, name, software, exclude_keywords=None):
        """
    ...
    def getDataFile_probabilities_with_name(self, name, software):
        """
